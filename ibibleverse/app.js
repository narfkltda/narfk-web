// iBibleVerse Landing Page JavaScript
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('%c📖 Welcome to iBibleVerse!', 'color: #18c231; font-size: 20px; font-weight: bold;');
    console.log('%cBible quiz app for growing in faith', 'color: #6e6e73; font-size: 14px;');
    console.log('%cDownload: https://apps.apple.com/app/apple-store/id[PLACEHOLDER]?pt=119728457&ct=narfkwebsite&mt=8', 'color: #18c231; font-size: 12px;');
});
